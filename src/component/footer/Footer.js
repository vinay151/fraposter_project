        ...
        <div className="grid lg:grid-cols-3 grid-cols-1 justify-items-center">
         <div className="text-white w-full lg:w-auto">
           ...
           <div className="flex items-center space-x-6 mt-5">
                    ...
                    <p className='  rounded-xl cursor-pointer bg-blue-900 p-2 text-white'> <FaFacebook className='text-xl '/> </p>
                    <p className='  rounded-xl cursor-pointer p-2 bg-cyan-500 text-white'> <FaTwitter  className='text-xl '/> </p>
                    <p className='  rounded-xl cursor-pointer p-2 bg-red-900 text-white'> <FaPinterestP  className='text-xl '/> </p>
                    <p className='  rounded-xl cursor-pointer p-2 bg-red-600 text-white'> <FaYoutube  className='text-xl '/> </p>
                    <p className='  rounded-xl cursor-pointer p-2 bg-blue-500 text-white'> <FaLinkedinIn  className='text-xl '/> </p>
                 </div>
         </div>
           ...
           <h1 className="text-2xl font-semibold">Quick Links</h1>
            <ul className="py-3">
              <li className="py-2"> <a href="#" > Search </a> </li>
              <li className="py-2"> <a href="#" > Review </a> </li>
              <li className="py-2"> <a href="#" > Contact Us </a> </li>
              <li className="py-2"> <a href="#" > Track Your Order </a> </li>
              <li className="py-2"> <a href="#" > Shippping Policy </a> </li>
              <li className="py-2"> <a href="#" > Refund Policy </a> </li>
