...
Do give us the feedback about the products we offer and any suggestions or ideas that would like to see. </p>
   ...
   <h1 className='text-4xl font-bold mt-5' data-aos="fade-down">CONTACT US</h1>
