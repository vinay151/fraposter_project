        ...
        <div className="flex flex-wrap mt-20">
          <div className="lg:w-1/2 border  w-full flex justify-center items-center regi  shadow-md ">
            <div className="text-white mt-20">
              ...
              <div className="flex mt-96 justify-between ">
                <p className="  rounded-xl cursor-pointer bg-blue-900 p-2 text-white">
                  {" "}
                  <FaFacebook className="text-3xl " />{" "}
                </p>
                <p className="  rounded-xl cursor-pointer p-2 bg-cyan-500 text-white">
                  {" "}
                  <FaTwitter className="text-3xl " />{" "}
                </p>
                <p className="  rounded-xl cursor-pointer p-2 bg-red-900 text-white">
                  {" "}
                  <FaPinterestP className="text-3xl " />{" "}
                </p>
                <p className="  rounded-xl cursor-pointer p-2 bg-red-600 text-white">
                  {" "}
                  <FaYoutube className="text-3xl " />{" "}
                </p>
                <p className="  rounded-xl cursor-pointer p-2 bg-blue-500 text-white">
                  {" "}
          ...
          <div className="lg:w-1/2 bg-gradient-to-t from-orange-400 to-sky-400  w-full py-16 px-8 shadow-md">
            <form>
              ...
              <div className="mt-5">
                <label htmlFor="cpassword" className="text-2xl">
                  Confirm Password
                </label>{" "}
                <br />
                <input
              ...
              <div className="mt-16 flex space-x-6">
                <button
                  type="button"
                  className="border-2 border-blue-600 text-2xl rounded-lg  cursor-pointer px-20 py-5 text-white bg-blue-600 hover:bg-transparent hover:text-black"
                >
                  {" "}
                  Register{" "}
                </button>
                <button
                  type="button"
                  className="underline  text-2xl rounded-lg  cursor-pointer px-20 py-5 text-white  hover:text-black"
                  onClick={handleClick}
                >
                  {" "}
